...
const DueDates = () => {
  ...
  const items = [
    { 
      ...
      coverColor: 'bg-gradient-to-br from-blue-100 to-blue-50 dark:from-blue-900/30 dark:to-blue-800/20',
      priority: 'high',
      progress: 75
    },
    { 
      ...
      coverColor: 'bg-gradient-to-br from-rose-100 to-rose-50 dark:from-rose-900/30 dark:to-rose-800/20',
      priority: 'critical',
      progress: 45
    },
    { 
      ...
      coverColor: 'bg-gradient-to-br from-indigo-100 to-indigo-50 dark:from-indigo-900/30 dark:to-indigo-800/20',
      priority: 'medium',
      progress: 20
    },
    { 
      ...
      coverColor: 'bg-gradient-to-br from-amber-100 to-amber-50 dark:from-amber-900/30 dark:to-amber-800/20',
      priority: 'high',
      progress: 90
    },
    { 
      ...
      coverColor: 'bg-gradient-to-br from-emerald-100 to-emerald-50 dark:from-emerald-900/30 dark:to-emerald-800/20',
      priority: 'low',
      progress: 10
    }
  ];
  ...
  const statusStyles = {
    overdue: {
      ...
      icon: <AlertTriangle className="h-3.5 w-3.5 text-rose-500 dark:text-rose-400" />,
      label: 'Overdue',
    ...
    upcoming: {
      ...
      icon: <CalendarDays className="h-3.5 w-3.5 text-blue-500 dark:text-blue-400" />,
      label: 'Upcoming',
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-amber-600 dark:text-amber-400">{stats.due}</p>
                </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
              />
            </div>
            <div className="relative">
              ...
              <select
                ...
                className="pl-10 pr-8 py-2.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors appearance-none"
              >
        ...
        >
          ...
          <div className="p-6">
            {filteredItems.length === 0 ? (
              ...
              >
                ...
                <p className="text-lg text-gray-500 dark:text-gray-400 mb-2">No books found</p>
              ...
              <div className="grid gap-4 sm:gap-6">
                {filteredItems.map((item, index) => (
                  <motion.div
                    ...
                    className={`p-4 sm:p-6 rounded-xl transition-all duration-300 ${statusStyles[item.status].border} border-2 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer group`}
                  >
                    <div className="flex gap-4">
                      <div className={`h-14 w-14 sm:h-16 sm:w-16 rounded-xl ${item.coverColor} flex items-center justify-center shadow-inner flex-shrink-0 group-hover:scale-105 transition-transform`}>
                        <BookOpen className="h-6 w-6 sm:h-7 sm:w-7 text-gray-700 dark:text-gray-300" />
                      </div>
                      
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between mb-3">
                          <div>
                            <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white leading-tight mb-1">
                              {item.title}
                            </h3>
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                          ...
                          <div className="flex items-center gap-3">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-xs font-medium text-gray-600 dark:text-gray-400">{item.progress}%</span>
                            </div>
                          </div>
                        </div>
                      </div>
          ...
          >
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <button className="flex items-center justify-center gap-2 text-sm font-medium text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors">
