...
const categories = [
  { icon: BookBookmark, labelKey: "Fiction" },
  { icon: Flask, labelKey: "Science" },
  { icon: Desktop, labelKey: "Technology" },
  { icon: Brain, labelKey: "Self-Development" },
  { icon: Bank, labelKey: "History" },
  { icon: ChartLineUp, labelKey: "Business" },
  { icon: PaintBrush, labelKey: "Arts" },
  { icon: Globe, labelKey: "Geography" },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        `}</style>
        <div
          className="hero-content-inner flex flex-col items-center w-full"
          style={{ paddingTop: `${ptMobile}px` }}
        >
          {/* Badge */}
          <div
          ...
          >
            ...
            {t("Build Bright University Library")}
          </div>
          ...
          >
            {t(
              "Access thousands of books, reserve your favorites, and manage your reading journey, all in one place.",
            )}
          </p>
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to top, rgba(0,0,0,0.99) 70%, transparent)",
        }}
      />
