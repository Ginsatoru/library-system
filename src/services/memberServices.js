...
const memberService = {
  ...
  getProfile: async () => {
    try {
      ...
      return {
        success: false,
        message: _extractError(error, "Failed to load profile."),
      };
    }
  },
  ...
  updateProfile: async ({ fullName, phone, address, gender }) => {
    try {
      ...
      return {
        success: false,
        message: _extractError(error, "Failed to update profile."),
      };
    }
  },
  ...
  uploadProfilePicture: async (file) => {
    try {
      ...
      const response = await api.post(
        "/MemberPortal/UploadProfilePictureJson",
        formData,
        {
      ...
      return {
        success: false,
        message: _extractError(error, "Failed to upload picture."),
      };
    }
  },
  ...
  changePassword: async ({
    ...
    try {
      ...
      return {
        success: false,
        message: _extractError(error, "Failed to change password."),
      };
    }
  },
  ...
  updateTelegram: async ({ telegramChatId, telegramUsername }) => {
    try {
      ...
      return {
        success: data?.success ?? false,
        message: data?.message || "Telegram updated.",
      };
    } catch (error) {
      if (_isUnauthorized(error)) return { success: false, message: null };
      return {
        success: false,
        message: _extractError(error, "Failed to update Telegram info."),
      };
    }
  },
  ...
  getHistory: async () => {
    try {
      ...
      return {
        success: false,
        message: _extractError(error, "Failed to load history."),
      };
    }
  },
...
disconnectTelegram: async () => {
  ...
  getWishlist: async () => {
    try {
      ...
      return {
        success: false,
        message: _extractError(error, "Failed to load wishlist."),
      };
    }
  },
  ...
  addToWishlist: async (catalogId) => {
    try {
      const response = await api.post("/MemberPortal/AddToWishlistJson", {
        catalogId,
      });
      const data = response.data;
      return { success: data?.success ?? false, message: data?.message };
      ...
      if (_isUnauthorized(error))
        return { success: false, message: null, unauthorized: true };
      return {
        success: false,
        message: _extractError(error, "Failed to add to wishlist."),
      };
    }
  },
  ...
  removeFromWishlist: async (catalogId) => {
    try {
      const response = await api.post("/MemberPortal/RemoveFromWishlistJson", {
        catalogId,
      });
      const data = response.data;
      return { success: data?.success ?? false, message: data?.message };
      ...
      return {
        success: false,
        message: _extractError(error, "Failed to remove from wishlist."),
      };
    }
  },
};
